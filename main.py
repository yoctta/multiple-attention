...
def aexp():
    ...
    Config=train_config(name,['ff-all-c23','efficientnet-b4'],url=url,attention_layer='b5',feature_layer='b2',epochs=20,batch_size=15,\
        ckpt='checkpoints/a1_b5_b7/ckpt_35.pth',inner_margin=[0.2,-0.8],margin=0.8)
    Config.mkdirs()
